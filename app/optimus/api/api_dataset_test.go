...
import (
	...
	testdata "github.com/jacklv111/optimus/app/light/api/test-data"
	"github.com/jacklv111/optimus/app/light/view-object/openapi"
	"github.com/jacklv111/optimus/infra/pipeline"
	...
	resmgmtsvc "github.com/jacklv111/optimus/pkg/resource-manager/light/service"
	mockresmgmt "github.com/jacklv111/optimus/pkg/resource-manager/light/service/mock"
	. "github.com/smartystreets/goconvey/convey"
	aifsclientgo "gitlab.gddi.com/algorithm/ai-infra/aifs-client/aifs-client-go"
	mockaifsclient "gitlab.gddi.com/algorithm/ai-infra/aifs-client/aifs-client-go/http-client/mock"
	aifsclient "gitlab.gddi.com/algorithm/tools/common-sdk/client/aifs-client"
	"gitlab.gddi.com/algorithm/tools/common-sdk/database"
	"gitlab.gddi.com/algorithm/tools/common-sdk/log"
	"gorm.io/gorm"
)
...
func TestMain(m *testing.M) {
	...
	db.AutoMigrate(&do.DatasetDo{}, &do.DataPoolDo{}, &do.DatasetVersionDo{}, &pipeline.PipelineDo{})
...
func TestApiDataset(t *testing.T) {
	...
	defer ctrl.Finish()
	mockResMgmt := mockresmgmt.NewMockLightResourceMgmtSvcInterface(ctrl)
	resmgmtsvc.LightResMgmtSvc = mockResMgmt
